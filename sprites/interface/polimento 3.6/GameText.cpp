...
void Game::BuildGameText()
{
	...
	else if( clock() - gameTimeStart >= 1000 && clock() - gameTimeStart < 1183 )//60 frames depois de começar
	{
		//nada
	}
	...
	/*
	else if( clock() - gameTimeStart > 3000 && )//180 frames depois de começar
	{
		
	}
	*/
	
	//textprintf_ex(gameScreen, font, 500, 315, makecol(255, 0, 0), -1, "%ld ", ( ( clock() - gameTimeStart - 2000 ) * 100 ) / 1000  );
